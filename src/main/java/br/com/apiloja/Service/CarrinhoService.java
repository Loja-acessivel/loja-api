...
public class CarrinhoService {
    ...
    public CarrinhoResponseDTO inserir(CarrinhoRequestDTO dto){
        ...
        carrinho.setStatus(dto.getStatus() == null || dto.getStatus().isBlank() ? "aberto" : dto.getStatus());
    ...
    public void deletar(Long id){
        Carrinho carrinho = repo.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Carrinho não encontrado com o ID: " + id));
